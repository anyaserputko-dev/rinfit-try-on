...
def render(p):
    ...
    L.camera(direction=(0.0, -math.cos(a), math.sin(a)), up=(math.sin(r), 0.0, math.cos(r)),
             target=(0, 0, 0), dist=p["dist"], lens=95)
...
P = dict(alpha=16.0, roll=0.0, dist=95.0, dome=0.95, edge_out=1.70, edge_in=0.55,
         inner_dome=0.10, thick=2.0, r_in=9.88, strip_arc=7.8, strip_phi=205.0)
STEPS = dict(alpha=8.0, roll=8.0, dist=14.0, dome=0.4, edge_out=0.6, edge_in=0.3,
             inner_dome=0.15, thick=0.35, r_in=0.7, strip_arc=1.6, strip_phi=14.0)
BOUNDS = dict(alpha=(3, 88), roll=(-40, 40), dist=(50, 200), dome=(0.15, 1.9), edge_out=(0.3, 3.2),
              edge_in=(0.1, 1.6), inner_dome=(0.0, 0.6), thick=(1.4, 3.0), r_in=(8.3, 11.0),
              strip_arc=(4.0, 14.0), strip_phi=(150, 260))
